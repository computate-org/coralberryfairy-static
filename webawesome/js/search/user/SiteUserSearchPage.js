Promise.all([
  ...
  document.querySelector('#pageSelectSortSiteUser_awesomeEffect')?.addEventListener('change', (event) => {
    sort('SiteUser', 'awesomeEffect', event.currentTarget.value);
  });

  document.querySelector('#pageStatsSiteUser_awesomeEffect')?.addEventListener('wa-show', (event) => {
    facetStatsChange('SiteUser', 'awesomeEffect', true);
  });
  document.querySelector('#pageStatsSiteUser_awesomeEffect')?.addEventListener('wa-hide', (event) => {
    facetStatsChange('SiteUser', 'awesomeEffect', false);
  });
